...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void startGame() throws LWJGLException, IOException
    {
        ...
        // this.drawSplashScreen(this.renderEngine); Old Splashscreen of Minecraft
        ...
        SplashProgress.setProgress(9, "Minecraft - GuiAchievement");
        GlStateManager.viewport(0, 0, this.displayWidth, this.displayHeight);
        this.effectRenderer = new EffectRenderer(this.theWorld, this.renderEngine);
        SplashProgress.setProgress(10, "Minecraft - EffectRender");
    ...
    private void createDisplay() throws LWJGLException
    {
        ...
        Display.setTitle("ezclient - 1.8.9");
    ...
    public void launchIntegratedServer(String folderName, String worldName, WorldSettings worldSettingsIn)
    {
    	...
    	Client.getInstance().getDiscordRP().update("Playing ezclient in singleplayermode", "In Game");
    }
